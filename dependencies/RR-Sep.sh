...
if [ ! -f $ors ]; then
	...
	gmt grdsample $bathy $box -G./ORStmp/trim.t.grd -V # the area of interest
	...
	do
		...
		gmt grdmath ORStmp/trim.t.grd $orsout/dim.${width}.grd SUB = ./ORStmp/${width}.resid.grd # residual from DiM
